...
<section class="newpage">
  ...
  <p>אם מופיע <b>מגיש חשבונית</b> — ממשיכים לפרק 4. אם לא — ראו פרק 7.</p>
</section>
...
<section>
  ...
  {faq('מילוי הטופס',
       ('אילו מסמכים צריך לצרף?',
        'זה משתנה מהטבה להטבה. יש הטבות שדורשות קבלה בלבד, ויש שדורשות מסמכים '
        'נוספים. המסמכים הנדרשים יפורטו בטופס.'),
...
<section class="newpage">
  <h2><span class="num">7</span> כשלא מופיע "הגשת בקשה"</h2>
  <p>לא בכל הטבה פוטנציאלית אפשר להגיש חשבונית דרך המצפן. כשהכפתור
     <b>הגשת בקשה</b> אינו מופיע, ההגשה נעשית באמצעות <b>העלאת מסמכים</b>
     באזור האישי:</p>
  <ol class="steps">
