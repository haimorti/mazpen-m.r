...
**הטבות שמתחילות בהגשת בקשה.** על הכפתור כתוב **"הגשת בקשה"**, ובכרטיס ההטבה כתוב "לבדיקת זכאות חדשה". ממלאים טופס קצר ומצרפים את המסמכים. הבקשה נבדקת על ידי המערכת, הבדיקה מהירה וברוב המקרים התשובה מתקבלת במהירות.
